...
public class CurrencyWithCommaDelimiterTest {

    @Before
    public void setup() {
        CurrencyLocale.getInstance().useCountryWithCommaDelimiter();
    }

    @Test
    public void withCommaDelimiter_testDecimal() throws Exception {
    ...
    @Test
    public void withCommaDelimiter_testNoDecimal() throws Exception {
